...
public class Programme_20_FindValueInArray {
    ...
    public static void main(String[] args) {
        ...
        int[]numArary = {1789,2035,1899,2040,1950,2255,7897,1455,787};
        System.out.println(isArrayContains(numArary,2035));
        System.out.println(isArrayContains(numArary,7999));
    }
}
